...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$AsyncResultCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class Initial<T> implements AsyncResult<T> {
...
class __$$AsyncSuccessImplCopyWithImpl<T, $Res>
    extends _$AsyncResultCopyWithImpl<T, $Res, _$AsyncSuccessImpl<T>>
...
abstract class AsyncSuccess<T> implements AsyncResult<T> {
...
class __$$AsyncFailureImplCopyWithImpl<T, $Res>
    extends _$AsyncResultCopyWithImpl<T, $Res, _$AsyncFailureImpl<T>>
...
class _$AsyncFailureImpl<T> implements AsyncFailure<T> {
  const _$AsyncFailureImpl(this.message);
  ...
  @override
  String toString() {
    return 'AsyncResult<$T>.failure(message: $message)';
  }
...
abstract class AsyncFailure<T> implements AsyncResult<T> {
  const factory AsyncFailure(final String message) = _$AsyncFailureImpl<T>;
