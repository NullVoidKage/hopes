...
mixin _$Lesson {
  ...
  int get estMins => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      estMins: null == estMins
          ? _value.estMins
          : estMins // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$LessonImpl implements _Lesson {
  ...
  @override
  String toString() {
    return 'Lesson(id: $id, moduleId: $moduleId, title: $title, bodyMarkdown: $bodyMarkdown, estMins: $estMins)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.estMins, estMins) || other.estMins == estMins));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, moduleId, title, bodyMarkdown, estMins);
...
abstract class _Lesson implements Lesson {
  const factory _Lesson(
      ...
      required final int estMins}) = _$LessonImpl;
