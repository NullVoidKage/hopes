...
abstract class $SubjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int gradeLevel});
}
...
class _$SubjectImpl implements _Subject {
  ...
  @override
  String toString() {
    return 'Subject(id: $id, name: $name, gradeLevel: $gradeLevel)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, gradeLevel);
...
abstract class _Subject implements Subject {
  const factory _Subject(
      ...
      required final int gradeLevel}) = _$SubjectImpl;
